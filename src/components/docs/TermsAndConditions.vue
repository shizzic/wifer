<template>
	<div class="wrap scroll">
		...
		<p>Welcome to wifer!</p>

		<p>These terms and conditions outline the rules and regulations for the use of wifer's Website, located at
			https://wifer.lol.</p>

		<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use wifer if
			you
		...
		<p>We employ the use of cookies. By accessing wifer, you agreed to use cookies in agreement with the
			wifer's
			Privacy Policy. </p>
		...
		<p>Unless otherwise stated, wifer and/or its licensors own the intellectual property rights for all material
			on
			wifer. All intellectual property rights are reserved. You may access this from wifer for your own
			personal use subjected to restrictions set in these terms and conditions.</p>

		<p>You must not:</p>
		<ul>
			<li>Republish material from wifer</li>
			<li>Sell, rent or sub-license material from wifer</li>
			<li>Reproduce, duplicate or copy material from wifer</li>
			<li>Redistribute content from wifer</li>
		</ul>

		<p>wifer reserves the right to monitor all Comments and to remove any Comments which can be considered
		...
		<p>You hereby grant wifer a non-exclusive license to use, reproduce, edit and authorize others to use,
			reproduce
		...
		<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
			...
			records
			with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of wifer; and
			(d)
		...
		<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
			must inform us by sending an e-mail to wifer. Please include your name, your organization name, contact
		...
		<p>No use of wifer's logo or other artwork will be allowed for linking absent a trademark license agreement.
		</p>
