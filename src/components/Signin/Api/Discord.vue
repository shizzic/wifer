...
export default {
    ...
    methods: {
        popup() {
            window.open('https://discord.com/oauth2/authorize?response_type=code&scope=email&client_id=' + (import.meta.env.VITE_DISCORD_ID || '__DISCORD_ID__') + '&redirect_uri=' + this.redirect_uri + '?method=Discord', '_self')
        },
    }
}
</script>
