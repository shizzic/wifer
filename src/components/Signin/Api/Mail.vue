...
export default {
    ...
    methods: {
        popup() {
            window.open('https://oauth.mail.ru/login?client_id=b45631bddba74618bff024652855d67e&response_type=code&scope=userinfo&state=' + Date.now() +'&redirect_uri=' + this.redirect_uri + '?method=Mail', '_self')
        }
    }
}
</script>
