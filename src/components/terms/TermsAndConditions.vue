<template>
	<div class="wrap scroll">
		...
		<p>Welcome to dateshipper!</p>

		<p>These terms and conditions outline the rules and regulations for the use of dateshipper's Website, located at
			https://dateshipper.com.</p>

		<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use dateshipper if
			you
		...
		<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all
			...
			accordance with and subject to, prevailing law of ge. Any use of the above terminology or other words in the
			singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring
			to
			same.</p>

		<h3><strong>Cookies</strong></h3>

		<p>We employ the use of cookies. By accessing dateshipper, you agreed to use cookies in agreement with the
			dateshipper's
			Privacy Policy. </p>
		...
		<p>Unless otherwise stated, dateshipper and/or its licensors own the intellectual property rights for all material
			on
			dateshipper. All intellectual property rights are reserved. You may access this from dateshipper for your own
			personal use subjected to restrictions set in these terms and conditions.</p>

		<p>You must not:</p>
		<ul>
			<li>Republish material from dateshipper</li>
			<li>Sell, rent or sub-license material from dateshipper</li>
			<li>Reproduce, duplicate or copy material from dateshipper</li>
			<li>Redistribute content from dateshipper</li>
		</ul>

		<p>dateshipper reserves the right to monitor all Comments and to remove any Comments which can be considered
		...
		<p>You hereby grant dateshipper a non-exclusive license to use, reproduce, edit and authorize others to use,
			reproduce
		...
		<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
			...
			records
			with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of dateshipper; and
			(d)
		...
		<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
			must inform us by sending an e-mail to dateshipper. Please include your name, your organization name, contact
		...
		<p>No use of dateshipper's logo or other artwork will be allowed for linking absent a trademark license agreement.
		</p>
